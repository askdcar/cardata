...
export default function LogoPage() {
  ...
  const fetchSliders = async () => {
    try {
      setLoading(true);
      const res = await fetch("https://api.amongcart.com/api/logo");
  ...
  const handleAddSlider = async () => {
    try {
      ...
      await fetch("https://api.amongcart.com/api/logo", {
        method: "POST",
        body: formData,
      });
  ...
  const handleEditSlider = async () => {
    try {
      ...
      await fetch(`https://api.amongcart.com/api/logo/${editSlider._id}`, {
        method: "PUT",
        body: formData,
      });
